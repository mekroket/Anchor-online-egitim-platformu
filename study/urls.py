...
from study.views import Anasayfa,about,KurslarView,trainers,articles,Register,Login,Kurs,Kategori,Hakkımızda,Cash,Detail
...
urlpatterns = [
    ...
    path("kurs-detay/<slug:slug>",Detail,name="kurs-detay"),
